...
class SimplexTable:
    ...
    def search_ref_solution(self):
        ...
        if res_col is not None:
            ...
            if minimum is None:
                raise Exception("Решения не существует! При нахождении опорного решения не нашлось минимального "
            ...
            raise Exception("Задача не имеет допустимых решений! При нахождении опорного решения не нашлось "
    ...
    def optimize_ref_solution(self):
        ...
        if res_row is None:
            raise Exception("Функция не ограничена! Оптимального решения не существует.")
